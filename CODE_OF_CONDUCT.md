...
This project follows the **Contributor Covenant 3.0**. Below you will find the code of conduct in **English**, followed by the **Polish** translation.

Ten projekt przestrzega zasad **Contributor Covenant 3.0**. Poniżej znajduje się tekst kodeksu w języku **angielskim**, a następnie jego **polskie** tłumaczenie.
...
Tensions can occur between community members even when they are trying their best to collaborate. Not every conflict represents a code of conduct violation.

When an incident does occur, it is important to report it promptly. To report a possible violation, **please email to: bydgoszczostrzolka@gmail.com**

Community Moderators take reports of violations seriously and will make every effort to respond in a timely manner. They will investigate all reports, reviewing messages, logs, and recordings. Enforcement actions are carried out in private with the involved parties.

### Addressing and Repairing Harm

If an investigation finds that this Code of Conduct has been violated, the following ladder may be used:

1. **Warning:** Private written warning and request for repair (e.g., apology).
2. **Temporarily Limited Activities:** A cooldown period with limited communication.
3. **Temporary Suspension:** A formal suspension with conditions for return.
...
This Code of Conduct is adapted from the **Contributor Covenant 3.0** (https://www.contributor-covenant.org/version/3/0/). Licensed under **CC BY-SA 4.0**.